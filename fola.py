...
class FedSystem(object):
    ...
    def plot_acc_loss(self, acc_list, loss_train, loss_test, round_num):
        ...
        plt.ylabel('Accuracy')
        plt.xlabel('epoch')
        plt.savefig('results/fola/figures/acc/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.png'.format(
        ...
        plt.ylabel('Loss')
        plt.xlabel('epoch')
        plt.savefig('results/fola/figures/train_loss/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.png'.format(
                args.n_client, args.data, args.activate_rate, args.alpha, round_num, args.lr, args.csd_importance, args.decay, args.n_epoch, args.weight, args.i_seed))
        ...
        plt.ylabel('Loss')
        plt.xlabel('epoch')
        plt.savefig('results/fola/figures/test_loss/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.png'.format(
                args.n_client, args.data, args.activate_rate, args.alpha, round_num, args.lr, args.csd_importance, args.decay, args.n_epoch, args.weight, args.i_seed))
...
if __name__ == '__main__':
    ...
    df1.to_excel('results/fola/data/acc/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.xlsx'.format(
    ...
    df2.to_excel('results/fola/data/train_loss/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.xlsx'.format(
            args.n_client, args.data, args.activate_rate, args.alpha, args.n_round, args.lr, args.csd_importance,
            args.decay, args.n_epoch, args.weight, args.i_seed))

    df3 = pd.DataFrame(loss_test, columns=['loss'])
    df3.to_excel('results/fola/data/test_loss/users_{}_data_{}_C{}_alpha_{}_round_{}_lr_{}_csd_{}_decay_{}_bs_{}_w_{}_seed_{}.xlsx'.format(
            args.n_client, args.data, args.activate_rate, args.alpha, args.n_round, args.lr, args.csd_importance,
            args.decay, args.n_epoch, args.weight, args.i_seed))
